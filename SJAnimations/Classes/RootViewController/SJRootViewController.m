...
- (NSMutableArray *)items {
    if (!_items) {
        NSArray *array = @[
                           ...
                           [SJItem itemWithName:@"自定义转场动画" object:[SJCustomTransitionsViewController class]],
                           [SJItem itemWithName:@"逐帧动画" object:[SJDisplayLinkViewController class]],
                           [SJItem itemWithName:@"粒子动画" object:[SJEmitterLayerViewController class]],
                           ...
                           [SJItem itemWithName:@"不规则UIButton点击效果" object:[SJPolygonViewController class]],
                           [SJItem itemWithName:@"图层复制，很炫酷的动画" object:[SJReplicatorLayerViewController class]],
                           [SJItem itemWithName:@"不规则图形动画" object:[SJShapeLayerViewController class]],
